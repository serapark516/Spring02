...
<c:if test="${not empty apple}"> 
	<table>
		<tr height="40"><td bgcolor="DarkOrange ">Jno</td><td>${apple.jno}</td></tr>
		<tr height="40"><td bgcolor="DarkOrange ">Chief</td><td>${apple.chief}</td></tr>
		<tr height="40"><td bgcolor="DarkOrange ">Jname</td><td>${apple.jname}</td></tr>
		<tr height="40"><td bgcolor="DarkOrange ">Note</td><td>${apple.note}</td></tr>
	</table>
</c:if>
<hr>
