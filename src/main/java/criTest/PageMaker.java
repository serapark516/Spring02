...
//	public void setCri(Criteria cri) { this.cri=cri; } // ver01
	public void setCri(SearchCriteria cri) { this.cri=cri; } // ver02
	...
	public String makeQuery(int currPage) {
		UriComponents uriCompenents = 
				UriComponentsBuilder.newInstance().
				queryParam("currPage", currPage).
				queryParam("rowsPerPage", cri.getRowsPerPage()).
				build();
		return uriCompenents.toString();
	} //makeQuery
	
	// ** ver02
	// => uri 에 search 기능 추가(Paging 시 에도 조건이 유지되도록)
	// => ?currPage=1&rowsPerPage=5&searchType=i&keyword=summer
